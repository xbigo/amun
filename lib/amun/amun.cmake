...
function(amun_reorg_project name )
	set(oneValue FOLDER)
	set(multiValues SOURCES INCLUDES FEATURES PRIVATE_SOURCES)
	cmake_parse_arguments(_local "" "${oneValue}" "${multiValues}" ${ARGN})

	if (DEFINED _local_SOURCES)
		target_sources(${name} PUBLIC ${_local_SOURCES})
	endif()

	if (DEFINED _local_PRIVATE_SOURCES)
		target_sources(${name} PUBLIC ${_local_PRIVATE_SOURCES})
	endif()
	...
	if (DEFINED _local_INCLUDES)
		target_include_directories(${name} INTERFACE "${_local_INCLUDES}")
	endif()
endfunction()
